...
const I18N = {
  ar: {
    ...
    sub: "إجابات واضحة عن أكثر ما يسأل عنه الزوار — ابحثي أو تصفحي القائمة أدناه.",
    searchPlaceholder: "ابحثي عن سؤال… (مثال: التواصل، الدفع، الصيانة)",
    ...
    ctaSub: "أرسلي سؤالك مباشرة وسأرد عليك في أقرب وقت ممكن.",
