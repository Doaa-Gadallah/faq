...
const I18N = {
  ar: {
    ...
    title: "امنصة الأسئلة الشائعة لدعم أعضاء هيئة التدريس",
    sub: "حرصًا من وحدة تكنولوجيا المعلومات – كلية التربية النوعية – جامعة المنصورة على تقديم الدعم الفني والتقني المستمر لأعضاء هيئة التدريس،تم إعداد منصة الأسئلة الشائعة لتكون مرجعًا إلكترونيًا مبسطًا وسريعًا للإجابة عن أكثر الاستفسارات شيوعًا.",
